...
class rolloutRecorder():
        ...
        while not rospy.is_shutdown():
            ...
            if True: #if self.running and not self.drop and self.grasped:
                ...
                if not self.nan_in_state:
                    ...
                    rospy.logwarn("NaN value detected in state array, data not appended")
    ...
    def config_display(self, blit):
        ...
        self.prediction_text = self.ax0.text(0.5, 0.5, 'No Prediction Yet', fontsize=20, horizontalalignment='center', verticalalignment='center', transform=self.ax0.transAxes)
