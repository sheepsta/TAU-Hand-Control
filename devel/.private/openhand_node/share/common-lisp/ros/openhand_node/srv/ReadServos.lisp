...
(cl:defmethod cl:initialize-instance :after ((m <ReadServos-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ReadServos-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name openhand_node-srv:<ReadServos-request> is deprecated: use openhand_node-srv:ReadServos-request instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ReadServos-request>)))
  ...
  "openhand_node/ReadServosRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ReadServos-request)))
  "Returns string type for a service object of type 'ReadServos-request"
  "openhand_node/ReadServosRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <ReadServos-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ReadServos-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name openhand_node-srv:<ReadServos-response> is deprecated: use openhand_node-srv:ReadServos-response instead.")))

(cl:ensure-generic-function 'pos-val :lambda-list '(m))
(cl:defmethod pos-val ((m <ReadServos-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader openhand_node-srv:pos-val is deprecated.  Use openhand_node-srv:pos instead.")
  (pos m))

(cl:ensure-generic-function 'enc-val :lambda-list '(m))
(cl:defmethod enc-val ((m <ReadServos-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader openhand_node-srv:enc-val is deprecated.  Use openhand_node-srv:enc instead.")
  (enc m))

(cl:ensure-generic-function 'ref-val :lambda-list '(m))
(cl:defmethod ref-val ((m <ReadServos-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader openhand_node-srv:ref-val is deprecated.  Use openhand_node-srv:ref instead.")
  (ref m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ReadServos-response>)))
  ...
  "openhand_node/ReadServosResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ReadServos-response)))
  "Returns string type for a service object of type 'ReadServos-response"
  "openhand_node/ReadServosResponse")
