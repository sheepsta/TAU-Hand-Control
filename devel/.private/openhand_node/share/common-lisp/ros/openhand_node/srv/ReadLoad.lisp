...
(cl:defmethod cl:initialize-instance :after ((m <ReadLoad-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ReadLoad-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name openhand_node-srv:<ReadLoad-request> is deprecated: use openhand_node-srv:ReadLoad-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <ReadLoad-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ReadLoad-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name openhand_node-srv:<ReadLoad-response> is deprecated: use openhand_node-srv:ReadLoad-response instead.")))

(cl:ensure-generic-function 'load-val :lambda-list '(m))
(cl:defmethod load-val ((m <ReadLoad-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader openhand_node-srv:load-val is deprecated.  Use openhand_node-srv:load instead.")
  (load m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ReadLoad-response>)))
  ...
  "openhand_node/ReadLoadResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ReadLoad-response)))
  "Returns string type for a service object of type 'ReadLoad-response"
  "openhand_node/ReadLoadResponse")
