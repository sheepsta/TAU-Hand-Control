...
(cl:defmethod cl:initialize-instance :after ((m <MoveServos-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MoveServos-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rollout-srv:<MoveServos-request> is deprecated: use rollout-srv:MoveServos-request instead.")))

(cl:ensure-generic-function 'pos-val :lambda-list '(m))
(cl:defmethod pos-val ((m <MoveServos-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rollout-srv:pos-val is deprecated.  Use rollout-srv:pos instead.")
  (pos m))
...
(cl:defmethod cl:initialize-instance :after ((m <MoveServos-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MoveServos-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rollout-srv:<MoveServos-response> is deprecated: use rollout-srv:MoveServos-response instead.")))

(cl:ensure-generic-function 'err-val :lambda-list '(m))
(cl:defmethod err-val ((m <MoveServos-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rollout-srv:err-val is deprecated.  Use rollout-srv:err instead.")
  (err m))
