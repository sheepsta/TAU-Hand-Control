...
class AprilTagDetection {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _arraySerializer.float64(obj.pixels, buffer, bufferOffset, null);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.pixels = _arrayDeserializer.float64(buffer, bufferOffset, null)
  ...
  static md5sum() {
    ...
    return 'b7c4776871a54eba6b676c9699f0e7df';
  }
