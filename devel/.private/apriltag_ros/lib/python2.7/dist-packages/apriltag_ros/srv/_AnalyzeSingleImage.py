...
class AnalyzeSingleImageResponse(genpy.Message):
  _md5sum = "6f8e6ad1566eb3849189b91a6b0dc6d0"
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.tag_detections.detections:
        ...
        buff.write(_struct_I.pack(length))
        pattern = '<%sd'%length
        buff.write(struct.Struct(pattern).pack(*val1.pixels))
        _v1 = val1.pose
        _v2 = _v1.header
        _x = _v2.seq
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        val1.pixels = s.unpack(str[start:end])
        _v8 = val1.pose
        _v9 = _v8.header
        start = end
        end += 4
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      for val1 in self.tag_detections.detections:
        ...
        buff.write(_struct_I.pack(length))
        pattern = '<%sd'%length
        buff.write(val1.pixels.tostring())
        _v15 = val1.pose
        _v16 = _v15.header
        _x = _v16.seq
        buff.write(_get_struct_I().pack(_x))
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        val1.pixels = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=length)
        _v22 = val1.pose
        _v23 = _v22.header
        start = end
        end += 4
...
class AnalyzeSingleImage(object):
  ...
  _md5sum = '8345823f2add454c149920ae5d459ae7'
