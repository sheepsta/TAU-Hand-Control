...
class AprilTagDetection(genpy.Message):
  _md5sum = "b7c4776871a54eba6b676c9699f0e7df"
...
float64 w
"""
  __slots__ = ['id','size','pixels','pose']
  _slot_types = ['int32[]','float64[]','float64[]','geometry_msgs/PoseWithCovarianceStamped']
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.pixels))
      _x = self
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.pixels = s.unpack(str[start:end])
      _x = self
      start = end
      end += 12
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(self.pixels.tostring())
      _x = self
      buff.write(_get_struct_3I().pack(_x.pose.header.seq, _x.pose.header.stamp.secs, _x.pose.header.stamp.nsecs))
      _x = self.pose.header.frame_id
      length = len(_x)
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.pixels = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=length)
      _x = self
      start = end
      end += 12
      (_x.pose.header.seq, _x.pose.header.stamp.secs, _x.pose.header.stamp.nsecs,) = _get_struct_3I().unpack(str[start:end])
